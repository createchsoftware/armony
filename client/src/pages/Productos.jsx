            ...
            <LayoutPrincipal>
                ...
                <main className='bg-[#F4F1ED] pb-20'>
                    ...
                    <section className='my-20  m-auto w-[80%] grid grid-cols-4 gap-8 text-center'>
                        <a href='#' className='grid items-center content-between justify-center max-w-xs grid-cols-1 gap-4 p-6 align-bottom transition duration-300 ease-in-out bg-white hover:scale-105 rounded-xl '>
                        ...
                        <div className='grid grid-cols-3 gap-2 '>
                            <div className='grid bg-white '>
                                ...
                                <div className='grid gap-2 p-6'>
                                    ...
                                    <p className='text-xs text-gray-500'>Encuentra las mejores ofertas para la
