    ...
    <>
      ...
      <div className="grid w-1/2 rounded-2xl p-1 m-auto shadow-lg mt-24 border-2 border-[#036C65]">
        ...
        <div className="grid p-4">
          <h1 className="text-3xl justify-self-center my-2">
            Recarga monedero
          </h1>
          <img
            className="w-24 h-auto justify-self-center"
            src="../../../pictures/logoArmony.png"
            alt=""
          />
          <label htmlFor="monto" className="my-6 text-2xl justify-self-center">
            Monto de Recarga:
          </label>
          <input
            type="text"
