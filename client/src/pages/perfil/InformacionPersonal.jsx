        ...
        <main className="grid p-12 m-12 md:flex">
          <div className="grid gap-6 md:w-[80%] m-auto">
            <section className="grid text-center rounded-2xl w-[100%] p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
              <a
                className="flex items-baseline text-md gap-x-4"
              ...
              <div className="flex ">
                <div className="w-[60%] place-content-end">
                  <section className=" grid gap-6 rounded-2xl  p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                    <h2 className="text-[#EB5765] font-bold text-2xl">
                      Datos de la cuenta:
                    </h2>
                    <div>
                      <div className="flex gap-x-4">
                ...
                <aside className="w-[40%] my-8 ">
                  <div className="grid gap-6 text-center ">
                    ...
                    <img
                      ...
                      src="../../../pictures/membresiaEjemplo.png"
                      alt=""
                    />
                    <a
                      href="/perfil/editar-perfil"
                      className="m-auto px-12 py-2  font-medium text-white whitespace-no-wrap bg-[#EB5765] border border-gray-200 rounded-full shadow-sm hover:cursor-pointer hover:bg-[#eb7580] focus:outline-none focus:shadow-none"
                    >
                      Editar
                    </a>
                  </div>
