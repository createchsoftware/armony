...
function ListaDeseo() {
  ...
  const [contResumen, setContResumen] = useState([
    ...
    },
    {
      ...
      precio: 1800,
      imagen: "../../../pictures/Hydrafacial.png",
      valoracion: 5,
      fav: true,
    },
    {
      ...
      precio: 1800,
      imagen: "../../../pictures/MesoterapiaVirtual.png",
      valoracion: 5,
      fav: true,
    },
    {
  ...
  const contenido = contResumen.map(
    (producto) =>
      (tipo === "all" || producto.tipo === tipo) && (
        ...
        >
          ...
          <img
            className="w-2/3 justify-self-center m-auto mb-4 rounded-lg aspect-square"
            src={producto.imagen}
            alt={producto.nombre}
          />
          <div>
            ...
            <p className="mt-0 text-xs text-justify">{producto.descripcion}</p>
          </div>
          <div className="grid mt-2">
            {producto.tipo === "1" ? (
              <button className=" text-xs gap-2  transition-all duration-300 px-8  hover:bg-[#036C65] hover:ring-1  hover:[#036C65] hover:ring-offset-1 group relative flex h-10 items-center justify-center overflow-hidden rounded-xl border-2 bg-[#EB5765] font-[abeatbykai] text-neutral-200">
                <span>Agregar</span> <IconoAgregarAlCarrito />{" "}
        ...
        <div className="flex w-[120%]">
          ...
          <div className="menu-deseo w-full">
            <img
              ...
              alt=""
              className="absolute -right-7 -rotate-90 w-60 h-180 top-60 z-0"
            />
            <div className="flex justify-center mt-5">
              <form
                action=""
                className="flex items-center w-4/5 justify-center border-2 border-[rgb(255,181,167)] rounded-lg"
              >
                <input
            ...
            <div className={width}>
              {contResumen.length === 0 ? (
                ...
                <>
                  ...
                  <h1 className="text-left text-xl px-6 mb-4">
                    Gastos de envío
                  </h1>
                  <p className="text-left text-gray-500 text-l px-6">
                  ...
                  <div className="grid">
                    <a
                      href="/spa/comprar"
                      className="bg-[#ec5766] p-2 text-white mx-6 rounded-xl my-2 duration-200 hover:bg-[#ffb5a7]"
                    >
                      Comprar
                    </a>
                  </div>
