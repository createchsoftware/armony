        ...
        <main className="grid gap-12 my-24">
          ...
          <section className="w-[60%] m-auto rounded-2xl p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            ...
            <div className="grid justify-end">
              <a
                href="/perfil/tarjetas/registroTarjeta"
                className="flex gap-2 items-center text-xl mr-12 w-max mt-8 relative before:bg-[#056761] before:absolute before:-bottom-1 before:block before:h-[1px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100 hover:font-bold"
              >
