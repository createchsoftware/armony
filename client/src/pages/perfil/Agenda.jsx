...
function Agenda() {
  ...
  const TituloTexto = () => {
    if (selectedDate === initialValue) {
      return "Citas Pendientes (Todas las fechas)";
    } else {
      return "Citas Pendientes el (" + selectedDate.format("DD/MM/YYYY") + ")";
    }
  };
  ...
  const citasMostrar = citasFiltradas.map((cita) => {
    ...
    return (
      <div
        key={cita.ID_Cita}
        className="flex py-0 pl-0 pr-6 shadow-2xl rounded-xl place-content-between"
      >
          ...
          <div className="my-4">
            ...
            <p>
              {firstLetterUppercase(nombreDia) +
                ...
                dia +
                ", " +
                firstLetterUppercase(nombreMes) +
                " " +
                año +
                ", " +
        ...
        <div className="flex gap-4 my-6">
          ...
          <button
            ...
            onClick={() => removeItem(cita.ID_Cita)}
          >
        ...
        <div className="flex items-start justify-center gap-4">
          ...
          <section className="w-1/2 p-2">
            <div className="flex justify-between gap-6 mb-6">
              <h2 className="text-[#EB5765] text-2xl">{TituloTexto()}</h2>
              <a href="/spa/agendar">
                <svg
                  width="24"
                  height="24"
