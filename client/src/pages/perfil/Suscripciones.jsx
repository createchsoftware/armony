      ...
      <main className="grid gap-12 my-24">
        <section className="rounded-2xl mt-12 w-[60%] m-auto p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          ...
          <img
            ...
            src="../../pictures/suscripcionCirculo.png"
            alt=""
          />
        ...
        <section className="w-[60%] m-auto">
          ...
          <div className="rounded-2xl m-auto grid gap-4 p-12 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <p className="text-sm text-justify">
              Esta es tu suscripción, será facturada en el mismo periodo de
              facturación.
            </p>
            <div className="rounded-xl m-auto w-1/3 text-center bg-[#45B59C] mt-4 my-auto  p-3">
              <div className="grid gap-2 px-2 py-6 bg-white rounded-lg">
                <img
                  className="w-48 m-auto mt-2"
                  src="../../../pictures/membresia1.png"
                  alt=""
                />
              </div>
            </div>
        ...
        <section className="w-[60%] m-auto">
          ...
          <div className="rounded-2xl  m-auto grid gap-4 p-12 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <p className="text-sm text-justify">
              Si no puedes esperar a obtener más beneficios, ¿Qué esperas?
              ¡Compra la suscripción para empezar a obtener beneficios más
              rápido!
            </p>
            <div className="flex items-center justify-start gap-8">
              ...
              <div className="grid gap-4">
                <p>
                  <span className="text-[#F584A7]">Tipo de compra:</span>{" "}
                  {"Suscripción"}
                </p>
                <p>
                  <span className="text-[#F584A7]">Precio: </span>
                  {"$199 MXN"}
                </p>
                <p>
                  <span className="text-[#F584A7]">
                    Tiempo de vigencia: {"Vigente por un mes"}
                  </span>
                </p>
              </div>
            </div>
            <p>
              Tan fácil como comprarlo por tan solo $199 MXN. Una vez llegado el
              día de facturación tu suscripción se te cobrará con la tarjeta
              añadida a tu cuenta. Puedes cancelar la suscripción cuando
              quieras.
            </p>
          </div>
        </section>
        ...
        <section className="w-[60%] m-auto">
          <h2 className="text-[#036C65] text-2xl ml-12 mb-4">
            Cancelar suscripción
          </h2>
          <div className="rounded-2xl m-auto grid gap-4 px-8 py-4 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <p className="text-sm text-justify">
              Una vez cancelada la suscripción, los cambios son irreversibles.
            </p>
            <button className="bg-gray-400 mt-6 py-3 w-1/2 m-auto shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-lg">
              Cancelar suscripción
            </button>
          </div>
        </section>
