                            ...
                            <form action="" className="grid gap-2 w-[55%] rounded-2xl p-4 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                                ...
                                <div className="px-10">
                                    <div className="grid">
                                        ...
                                        <div className="flex">
                                            {/* VISA */}
                                            <svg className="w-12 mr-4" viewBox="0 -140 780 780" enableBackground="new 0 0 780 500" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                            ...
                                            {/* MASTER CARD */}
                                            <svg className="w-12 mr-4" viewBox="0 -54.25 482.51 482.51" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                    ...
                                    <div className="grid mt-4">
                                        ...
                                        <input type="text" id='titular' name='titular' className="grid mt-2 rounded shadow-md"/>
                                    </div>
                                    <div className="grid mt-4">
                                    ...
                                    <div className="flex justify-around mt-4">
                                        ...
                                        <div className="grid">
                                            ...
                                            <input type="text" id='cvv' name='cvv' className='w-20 justify-self-center text-center rounded shadow-md' />
                                        </div>
                                    ...
                                    <div className="grid mt-4">
                                        <div>
                                            ...
                                            <label htmlFor="recordar" className="ml-2">Recordar tarjeta</label>
                                        </div>
                                        <div>
                                            <input type="checkbox" id='principal' name='principal'/>
                                            <label htmlFor="principal" className="ml-2">Poner como tarjeta principal</label>
                                        </div>
                                    </div>
                                    <div className="flex justify-end mt-4">
                                        <a href="/perfil/tarjetas" className='bg-[#fccfc6] cursor-pointer justify-self-center mr-4 text-xl text-[#EB5765] px-10 py-2 rounded-full duration-200 hover:font-bold'>Cancelar</a>
                                        <button id='add-Tarjeta' className='bg-[#ec5766] cursor-pointer justify-self-center text-xl text-white px-10 py-2 rounded-full duration-200 hover:bg-[#ffb5a7]'>Agregar tarjeta</button>
                                    </div>
                                </div>
                            </form>
                            ):(
