import presentacion from "../../../public/pictures/presentacionestetica.png";
import esteticavista from "../../../public/pictures/esteticavista.png";

function PresentacionEstetica() {
  return (
    <>
      ...
      <div className="w-full">
        <div
          style={{
            backgroundImage: `url(${esteticavista})`,
...
export default PresentacionEstetica;
