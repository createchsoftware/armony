function Foot() {
  return (
    <>
      <footer
        className="selection:bg-[#EB5765]  selection:text-white font-[abeatbyKai] text-white bg-gradient-to-b from-[#036C65] to-black"
        id="contacto"
      >
        {/* Top  */}
          ...
          <div className="grid grid-cols-1 gap-0 px-4 py-6 lg:py-8 md:grid-cols-3 md justify-items-center">
            <div className="flex items-center ">
              <svg
                ...
                height="44"
                viewBox="0 0 250 250"
                className="h-10 p-1 overflow-visible bg-[#D9D9D9] rounded-full drop-shadow-md"
              >
                <g
                  fill="#1976d2"
                  fillRule="nonzero"
              ...
              <div className="m-6 grid gap-6">
                ...
                <p className="w-[200px]">
                  +52 (686) 123-4567 <br /> +52 (686) 456-78910
                </p>
              </div>
            </div>
            <div className="flex items-center md:">
              ...
              <div className="m-6">
                <p className=" text-xl grid gap-6 text-[#B2B2B2] mb-6">
                  Correo
                </p>
                <ul className="w-[200px]">
                  <li>
                    <a href="">info@armony.com</a>
                  </li>
                  <li>
                    <a href="">support@armony.com</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="flex items-center ">
              ...
              <div className="m-6 ">
                ...
                <p className="w-[200px]">
                  Calz. Francisco L. Montejano 2, Residencia, Mexicali, B.C.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-screen-xl w-[80%]">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 justify-items-center mb-8 md:mb-24">
            <div className="">
              <h2 className="mb-6 text-sm font-semibold  uppercase text-[#B2B2B2]">
                Armony
              </h2>
              <ul>
                <li>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-[#B2B2B2] uppercase">
                Servicios
              </h2>
              <ul>
                <li>
          ...
          <div className="px-4 py-6 md:p-0 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
              <a href="https://flowbite.com/"></a>Copyright © 2024 Armony. All
              Rights Reserved.
            </span>
