            ...
            <div className='flex justify-between mx-16 my-10'>
                ...
                <div className="rounded-xl shadow-md w-[55%] border-2 border-gray">
                    <div className='grid bg-[rgb(3,109,99)] rounded-t-xl'>
                        <p className='text-white text-2xl py-2 ml-8'>¿Cómo quieres pagar?</p>
                    </div>
                    <div className='px-6 pt-6 overflow-y-auto'>
                        <ul>
                            <li className="flex items-center justify-between shadow-md rounded-3xl px-4 border-2 border-gray mb-4">
                                <svg className="w-36" viewBox="0 0 141.732 141.732" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                ...
                                <h1 className="text-xl">BARNOTE</h1>
                                <h1 className="text-xl">Débito</h1>
                                <h1 className="text-xl">****</h1>
                                <h1 className="text-xl">5096</h1>
                                <button onClick={togglePago} className='bg-[#ec5766] text-xl text-white px-10 py-2 rounded-full duration-200 hover:bg-[#ffb5a7]'>Cotinuar</button>
                            </li>
                            <li className="flex items-center justify-between shadow-md rounded-3xl px-4 border-2 border-gray mb-4">
                                <svg className="w-36" viewBox="0 -54.25 482.51 482.51" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                ...
                                <h1 className="text-xl">NU BN...</h1>
                                <h1 className="text-xl">México</h1>
                                <h1 className="text-xl">****</h1>
                                <h1 className="text-xl">2947</h1>
                                <button onClick={togglePago} className='bg-[#ec5766] text-xl text-white px-10 py-2 rounded-full duration-200 hover:bg-[#ffb5a7]'>Cotinuar</button>
                            </li>
                            <li className="flex items-center justify-between shadow-md rounded-3xl px-4 border-2 border-gray mb-4">
                                <svg className='w-36' fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 459.669 459.669" xmlSpace="preserve"
                                    ><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                ...
                                <button onClick={toggleTarjeta} className='bg-[#ec5766] text-xl text-white px-10 py-2 rounded-full duration-200 hover:bg-[#ffb5a7]'>Cotinuar</button>
                            </li>
                            <li className="flex items-center justify-between shadow-md rounded-3xl px-4 border-2 border-gray mb-4">
                                <svg className="w-36" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 442.979 442.979" xmlSpace="preserve">
                ...
                <div className="w-[40%]">
                    {/* Bloque de resumen */}
                    <div  className="rounded-xl shadow-md border-2 border-gray mb-10">  
                        <div className='grid bg-[rgb(3,109,99)] rounded-t-xl'>
                            <p className='text-white text-2xl py-2 ml-8'>Pago</p>
                        </div>
                    ...
                    {/* Bloque "Aceptamos" */}
                    <div className="rounded-xl shadow-md border-2 border-gray">  
                        <div className='grid bg-[rgb(3,109,99)] rounded-t-xl'>
                            <p className='text-white text-2xl py-2 ml-8'>Aceptamos</p>
                        </div>
                        <div className='flex justify-between px-6 pt-6'>
                            <svg className="w-36" viewBox="0 0 141.732 141.732" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                            ...
                            <svg className="w-36" viewBox="0 -140 780 780" enableBackground="new 0 0 780 500" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" fill="#000000">
