...
function Presentacion() {
  return (
    <>
      <div
        className="p-4 bg-gradient-to-r w-2/3 md:w-1/3  mt-16 from-[#FAD0C4] to-[#FF9A9E] rounded-r-full left-0 z-100"
        id="info"
      >
      ...
      <img
        src={greenLeft2}
        alt=""
        className="absolute w-[12%] left-0 translate-y-[-8rem] z-[-1]"
      />
        ...
        <div className="items-center gap-0 text-center md:grid md:grid-cols-2 place-content-center">
          <div className="md:p-16 bg-gradient-[#F6EECF] mt-0  from-[#F6EECF] to-[#DDF3FA] rounded-xl">
            <p className="font-[abeatbyKai] mt-6  md:text-2xl text-[rgb(3,108,101)]">
              El que te veas hermosa y te sientas bien es nuetras prioridad, por
              ello, ven y consiéntete con nuestro equipo de terapeutas y
              estilistas expertos que te proporcionarán desde tratamientos
              faciales rejuvenecedores y masajes relajantes, hasta un nuevo
              corte de cabello y maquillaje para esas ocasiones específicas.
            </p>
