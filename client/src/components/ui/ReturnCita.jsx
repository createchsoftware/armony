            ...
            <div className="flex justify-between w-full">
                <div className='flex justify-between gap-4 '>
                    ...
                    <div className='grid place-content-center'>
                        ...
                        <p className='text-sm'>especialista: {citas.especialista}</p>
                        <p className='text-sm'>sesiones: {citas.sesiones}</p>
                        <p className='text-sm'>fecha: {citas.fecha}</p>
                        <p className='text-sm'>hora: {citas.hora}</p>
                    </div>
                </div>
