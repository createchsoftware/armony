                ...
                <div className='z-30 cart-fondo'>
                    <div className='cart-fx'>
                        <div className='grid mt-16 w-[60%] bg-white rounded-2xl m-auto py-4'>
                            ...
                            <div className="w-1/2 my-3 border border-black  justify-self-center" />
                            <h1 className="mb-5 text-xl  justify-self-center">{`Fecha: ${producto.day} / ${producto.month} / ${producto.year}`}</h1>
                            <div className="flex justify-between px-12">
                                <div className="grid w-[35%] justify-items-center">
                                    <h1 className="overflow-hidden text-2xl font-bold">{producto.nombre}</h1>
                                ...
                                <div className="grid w-[55%]">
                                    <div className="flex items-center justify-center py-1 border-t border-b border-black">
