...
//                             <h2 className=' text-white p-0 w-[100%] m-auto font-[iloveglitter] text-9xl text-center '>{subtitle}</h2>
//                             <h2 className=' text-white w-[100%] m-auto  font-[abeatbykai] text-2xl mt-6  text-center' >{description}</h2>
//                             <button className=" font-[abeatbykai] w-40 leading-none mt-16 m-auto h-10 overflow-hidden rounded-lg border-2 bg-transparent px-5 py-2.5 text-white transition-all duration-300 hover:bg-neutral-800 hover:ring-2 hover:ring-neutral-800 hover:ring-offset-2"><span className="relative">Mostrar más...</span></button>
//                         </div>
//                         {/* <p className="legend">Pilar 1</p> */}
//                     </div>
