        ...
        <>
            <footer class="selection:bg-[#EB5765]  selection:text-white font-[abeatbyKai] text-white bg-gradient-to-b from-[#036C65] to-black">
                ...
                <div className="border-4  border-white w-[80%] aspect-video mb-20 m-auto">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6881541.445936444!2d-125.208034575!3d32.6294237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d7714225033f79%3A0xb205ba7b621e4483!2sArmony%20beauty%20%26%20spa!5e0!3m2!1ses-419!2smx!4v1712312337166!5m2!1ses-419!2smx"
                ...
                <div class="mx-auto max-w-screen-xl w-[80%]">
                    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 justify-items-center mb-8 md:mb-24">
                        <div className="">
                            <h2 class="mb-6 text-sm font-semibold  uppercase text-[#B2B2B2]">Armony</h2>
                            <ul>
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-[#B2B2B2] uppercase">Servicios</h2>
                            <ul>
                                <li><a className='flex justify-center' href="#"
                                    class="relative inline  cursor-pointer  before:bg-white  before:absolute before:-bottom-1 before:block before:h-[1px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold uppercase text-[#B2B2B2]">Productos</h2>
                            <ul>
                                <li><a className='flex justify-center' href="#"
                                    class="relative inline  cursor-pointer  before:bg-white  before:absolute before:-bottom-1 before:block before:h-[1px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100">
                                    Clinica</a></li>
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold  uppercase text-[#B2B2B2]">Contactos</h2>
                            <ul>
                                <li><a className='flex justify-center' href="#"
                                    class="relative inline  cursor-pointer  before:bg-white  before:absolute before:-bottom-1 before:block before:h-[1px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100">
