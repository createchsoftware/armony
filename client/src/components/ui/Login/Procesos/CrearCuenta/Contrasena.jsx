            ...
            <form action="" className="grid grid-cols-1 place-content-start">
              ...
              <div className="relative">
                <InputContrasena props={{ 
                  ...
                  class: "bg-slate-200 rounded-full w-[365px] mb-3 mt-2 py-2 focus:outline-none focus:ring-1 focus:ring-rose-400 focus:border-transparent px-6", 
                  classEye: "absolute top-[2.5rem] md:top-[1rem] left-[15rem] md:left-[20.75rem]", 
                }}
                />
              </div>
              {/*<input
