import membresias from '../../../public/pictures/membresias.png'
...
function Membresias() {
    return (
        ...
        //     </aside>
        //     <body className='w-1/2 px-20 py-12'>
        //         <header className='text-6xl font-[iloveglitter] text-[#036C65]'>
        //             <h1>Conoce nuestras membresías</h1>
        //         </header>
        //         <p className='mt-12'>
        //             ¡Unete a nuestra familia de bienestar! Conviertete en miembro de nuestro spa y disfruta de acceso exclusivo a tratamientos personalizados, descuentos especiales y promociones unicas. ¡Tu bienestar merece ser prioridad!                </p>
        //         <button className="mt-16 transition-all duration-300 w-48 m-auto hover:bg-black hover:ring-2 hover:ring-neutral-800 hover:ring-offset-1 group relative inline-flex h-10 items-center justify-center overflow-hidden rounded-lg border-2 bg-[#EB5765] px-6 font-[abeatbykai] text-neutral-200"><span>Ver más</span><div className="w-0 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-1 group-hover:opacity-100"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5"><path d="M8.14645 3.14645C8.34171 2.95118 8.65829 2.95118 8.85355 3.14645L12.8536 7.14645C13.0488 7.34171 13.0488 7.65829 12.8536 7.85355L8.85355 11.8536C8.65829 12.0488 8.34171 12.0488 8.14645 11.8536C7.95118 11.6583 7.95118 11.3417 8.14645 11.1464L11.2929 8H2.5C2.22386 8 2 7.77614 2 7.5C2 7.22386 2.22386 7 2.5 7H11.2929L8.14645 3.85355C7.95118 3.65829 7.95118 3.34171 8.14645 3.14645Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg></div></button>
        //     </body>
        // </div>
    )
}
