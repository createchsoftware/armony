  ...
  return (
    <div className="w-[17rem] mt-5">
      ...
      <div className="w-[13rem] h-[10rem] mx-auto bg-rose-100 rounded-3xl ring-1 ring-rose-300 py-3">
        ...
        <p className="pl-5 text-base">Duracion: {servicio.duracion} min</p>
        ...
        <button className="px-10 py-1 mx-10 font-bold bg-red-50 rounded-xl ring-1 ring-rose-50 hover:ring-black">
          Elegir
        </button>
      </div>
    </div>
