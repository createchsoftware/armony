    ...
    return (
        <>
            <section className='grid grid-cols-4 gap-8 m-auto my-20 text-center'>
                ...
                <div onClick={handleClickManicuraPedicura} className='grid items-center content-between justify-center max-w-xs grid-cols-1 gap-4 p-6 align-bottom transition duration-300 ease-in-out bg-white hover:cursor-pointer hover:scale-105 rounded-xl '>
                ...
                <div onClick={handleClickCapilar} className='grid items-center content-between justify-center max-w-xs grid-cols-1 gap-4 p-6 align-bottom transition duration-300 ease-in-out bg-white hover:cursor-pointer hover:scale-105 rounded-xl '>
