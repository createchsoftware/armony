      ...
      <div className="carrusel" id="inicio">
        <div className="cont-carrusel" id="car-video">
          <section className="videos">
            ...
            <p className="desc">
              Relájate y déjate llevar por la serenidad mientras nuestros
              expertos cuidan de tú bienestar en nuestro spa exclusivo.
            </p>
            <a href="/spa" className="show">
              Mostrar más...
            </a>
          ...
          <section className="videos">
            ...
            <p className="desc">
              Tu lugar de encuentro, donde el buen café y las sonrisas se
              mezclan.
            </p>
            <a href="#" className="show" onClick={toggleSoon}>
              Mostrar más...
            </a>
            <video autoPlay loop className="slider-video" muted>
          ...
          <section className="videos">
            ...
            <p className="desc">
              La salud es un hábito tan importante como ser feliz. Únete a
              nuestra comunidad y deja que nuestros expertos de guíen al
              bienestar.
            </p>
            <a href="#" className="show" onClick={toggleSoon}>
              Mostrar más...
          ...
          <section className="videos">
            <h1 className="my-24 title md:my-0" id="title4">
              School
            </h1>
          ...
          <section className="videos">
            ...
            <p className="desc">
              Se bienvenida al departamento de emprendimiento, donde tus ideas
              van más allá que sólo alcanzar el éxito.
            </p>
            <a href="#" className="show" onClick={toggleSoon}>
              Mostrar más...
            </a>
            <video autoPlay loop className="slider-video" muted>
              <source
                src="../../../videos/5Emprendimiento.mp4"
                type="video/mp4"
              />
            </video>
          </section>
          <section className="videos">
            ...
            <p className="desc">
              Un regalo para una sonrisa que nos llena de alegría todos los
              días. Ven y encuentra tú favorito.
            </p>
            <a href="#" className="show" onClick={toggleSoon}>
              Mostrar más...
            </a>
        ...
        <ul className="slide-sec">
          <li className="selec active">
            <FontAwesomeIcon icon={faDiamond} rel="0" />
          </li>
          <li className="selec">
            <FontAwesomeIcon icon={faDiamond} rel="1" />
          </li>
          <li className="selec">
            <FontAwesomeIcon icon={faDiamond} rel="2" />
          </li>
          <li className="selec">
            <FontAwesomeIcon icon={faDiamond} rel="3" />
          </li>
          <li className="selec">
            <FontAwesomeIcon icon={faDiamond} rel="4" />
          </li>
          <li className="selec">
            <FontAwesomeIcon icon={faDiamond} rel="5" />
          </li>
          <li className="selec">
            <FontAwesomeIcon icon={faDiamond} rel="6" />
          </li>
        </ul>
      </div>
      {/*<div className="carrusel" id="inicio">
      ...
      <div className="somos" id="nosotros">
        ...
        <div className="somos-div">
          <section className="somos-arm">
            <h3 id="somos-text">
              Nos especializamos en brindarte servicios y productos que resalten
              tu belleza interior.
            </h3>
            <h3 id="somos-desc">
              ...
              desarrollo personal. Te invitamos a descubrir todo lo que armony
              tiene para ofrecer, y a sumergirte en un mundo de serenidad,
              belleza y crecimiento personal. ¡Bienvenida a armony, donde la
              armonía es nuestra filosofía de vida!
            </h3>
          </section>
          ...
          <div id="pilares-visibles">
            ...
            <div className="pilar no7 no3" rel={2}>
              <a href="/spa" className="pilar-btn">
                <h3 className="pilar-text">
                  Spa
                  <br />
                  Salon &amp; Beauty
                </h3>
                <img
                  src="../../../pictures/7spa.jpg"
                  alt=""
                  className="pilar-photo"
                />
                <div className="deg2" />
