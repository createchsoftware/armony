        ...
        <>
            <header className="header">
                <div>
                    <nav className="nav" >
                        <a href="#">
                            <img src="../../../public/pictures/armonyLogo.png" alt="" className="logo" />
                        </a>
                ...
                <div className="cont-carrusel" id="car-video">
                    <section className="videos">
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/1Cafeteria.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <section className="videos">
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/2Wellness.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <section className="videos">
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/3Spa.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <section className="videos">
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/4School.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <section className="videos">
                        <h1 className="title" />
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/5Emprendimiento.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <section className="videos">
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/6Colectivo.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <section className="videos">
                        <h1 className="title" />
                        ...
                        <video autoPlay="" loop="" className="slider-video">
                            <source src="../../../public/picturesos/7Clínica.mp4" type="video/mp4" />
                        </video>
                    </section>
                    <div className="deg1" />
                    <div className="deg" />
            ...
            <div className="somos" id="nosotros">
                <img src="../../../public/pictures/logoArmony.png" alt="" id="logo1" />
                <h1 id="titulo">resalta tu belleza interior.</h1>
                <div className="somos-div">
                    ...
                    <section className="somos-fotos">
                        <img src="../../../public/pictures/decoArmony2.png" alt="" id="fondo" />
                        <img src="../../../public/picturesenes/armonyImagen1.png" alt="" id="foto1" />
                        <div id="circulo1">
                            <img src="../../../public/picturesenes/armonyImagen2.png" alt="" id="foto2" />
                        </div>
                        <div id="circulo2">
                            <img src="../../../public/picturesenes/armonyImagen3.png" alt="" id="foto3" />
                        </div>
                    </section>
                </div>
            </div>
            ...
            <div className="pilares">
                <img src="../../../public/pictures/decoArmony1.png" alt="" id="deco1" />
                <img src="../../../public/pictures/decoArmony.png" alt="" id="deco2" />
                ...
                <div className="pilares-cont">
                    ...
                    <div id="pilares-visibles">
                        <div className="pilar no1" attr={0}>
                            <h3 className="pilar-text">Cafetería Cultura &amp; Art</h3>
                            <img
                                src="../../../public/picturesenes/1cafeteria.jpg"
                                alt=""
                                className="pilar-photo"
                            />
                            <div className="deg2" />
                        </div>
                        <div className="pilar no2" attr={1}>
                            <h3 className="pilar-text">Wellness Hábitos saludables</h3>
                            <img
                                src="../../../public/picturesenes/2wellness.jpg"
                                alt=""
                                className="pilar-photo"
                            />
                            <div className="deg2" />
                        </div>
                        <div className="pilar no3" attr={2}>
                            <h3 className="pilar-text">Colectivo Regalos &amp; More</h3>
                            <img
                                src="../../../public/picturesenes/3colectivo.jpg"
                                alt=""
                                className="pilar-photo"
                            />
                            <div className="deg2" />
                        </div>
                        <div className="pilar no4" attr={3}>
                            <h3 className="pilar-text">Emprendimiento &amp; Fly</h3>
                            <img src="../../../public/picturesenes/4fly.jpg" alt="" className="pilar-photo" />
                            <div className="deg2" />
                        </div>
                        <div className="pilar no5" attr={4}>
                            <h3 className="pilar-text">School Knowlegde &amp; Learning</h3>
                            <img
                                src="../../../public/picturesenes/5school.png"
                                alt=""
                                className="pilar-photo"
                            />
                            <div className="deg2" />
                        </div>
                        <div className="pilar" attr={5}>
                            <h3 className="pilar-text">Clínica</h3>
                            <img
                                src="../../../public/picturesenes/6clinica.jpg"
                                alt=""
                                className="pilar-photo"
                            />
                            <div className="deg2" />
                        </div>
                        <div className="pilar" attr={6}>
                            <h3 className="pilar-text">Spa Salon &amp; Beauty</h3>
                            <img src="../../../public/picturesenes/7spa.jpg" alt="" className="pilar-photo" />
                            <div className="deg2" />
                        </div>
                    </div>
                </div>
