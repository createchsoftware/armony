        ...
        if(galleta){
            ...
            if(campos_incorrectos.length > 0 ){
                ...
                let insercion_exitosa = new Promise((resolve, reject) => {
                    solicitud.database.query(consult, buzon, (error,resultados)=>{
                        if(error){
                            reject(error)
                        }
                ...
                if( primer_resultado_mysql == true){
                    ...
                    let insercion_exitosa2 = new Promise((resolve, reject) => {
                        solicitud.database.query(consulta, paramteros, (error, resultados) => {
                            if(error)
                                reject(error);
