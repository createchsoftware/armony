        ...
        if(galleta4){
            ...
            if(galleta1 && galleta2 && galleta3){
                ...
                try{
                    ...
                    let insercion_exitosa = new Promise((resolve, reject) => {
                    ...
                    const id_usuario = await insercion_exitosa;
                        ...
                        //     let llave = `patologia${i}`;
                        //     values.push(decodificada2[llave])
                        // }
                        
                        // for(let i=0;i<values.length;i++){
                        //     values[i].unshift(id_usuario);
                        // }
    
                        // console.log(values);
    
                        // let consulta2 = "insert into clientepato values ?";
    
                        // solicitud.database.query(consulta2,[values],async (error,resultados)=>{
                        //     if(error)
                        //         throw error;
                                
                        //     console.log("patologias anadidas exitosamente");
                        // })
